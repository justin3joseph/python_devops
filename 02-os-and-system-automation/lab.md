# Module 02 — Python for DevOps: OS and System Automation
...
# Lab 01 — Working with Directories

## 🎯 Objective

Use `os` and `pathlib` to inspect and create directories.
...
`os`, `pathlib`, environment variables, `sys.argv`, directory creation, and safe path handling.

## 🧩 Task

Complete **Lab 01 — Working with Directories**.
...
Read and use environment variables safely.
...
Complete **Lab 02 — Environment Variables**.
...
for name in ["USER", "HOME", "SHELL", "PATH"]:
...
# Lab 03 — Command-Line Arguments

## 🎯 Objective

Pass a directory to a Python script and inspect it.
...
Complete **Lab 03 — Command-Line Arguments**.
...
# Lab 04 — Automated Directory Setup

## 🎯 Objective

Create a standard DevOps project directory structure.
...
Complete **Lab 04 — Automated Directory Setup**.
...
for directory in ["logs", "backup", "reports", "scripts"]:
    Path(directory).mkdir(parents=True, exist_ok=True)

print("DevOps directory structure created.")
```
